...
if "__main__" == __name__:
    ...
    parser.add_argument(
        "--alignment",
        choices=[None, "least_square", "least_square_disparity", "least_square_log_depth"],
        default=None,
    ...
    for data in tqdm(dataloader, desc="Evaluating"):
        ...
        elif "least_square_log_depth" == args.alignment:
            # convert GT dpeth -> GT log depth
            gt_log_depth = np.log(depth_raw + 1.)

            # LS alignment in log space
